                ...
                <thead>
                    <tr className=" bg-slate-50">
                        <th className="flex items-center h-full px-4 py-3 border-r border-[#d9d9d9] font-light text-left gap-2"
                            onClick={handleSort}>
                            <span className="text-f-2xl text-neutral-1400">Vintage</span>
                            <svg
                                className="w-4 h-4"
                                viewBox="0 0 17 16"
                                fill="none"
                        ...
                        <th className="items-center px-4 py-3 border-r  border-[#d9d9d9] font-light text-left">
                            <span className="text-f-2xl text-neutral-1400">Available Credits (tCO₂e)</span>
                        </th>

                        <th className="items-center px-4 py-3 font-light text-left">
                            <span className="text-f-2xl text-neutral-1400">Price per Credit ($)</span>
                        </th>
                    </tr>
                </thead>
                <tbody>
                    {sortedVintages.map((vintage, index) => (
                        vintage.total_credit != 0 && <tr key={vintage.year} className={index % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>
                            <td className="p-4 text-f-l border font-semibold font-light text-neutral-1200">{vintage.year}</td>
                            <td className="p-4 text-f-l border text-left font-light text-neutral-1200">{formatNumber(vintage.total_credit, 3)}</td>
                            <td className="p-4 text-f-l border text-left font-light text-neutral-1200">{formatNumber(vintage.per_credit_price, 2)}</td>
                        </tr>
                    ))}
                </tbody>
            </table>
