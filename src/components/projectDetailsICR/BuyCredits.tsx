                ...
                <table className="min-w-full bg-white rounded-lg ">
                    ...
                    <tbody>
                        {projectDetails.vintages && projectDetails.vintages.map((vintage: any, index: any) => (
                            <tr key={index}>
                                <td className="p-4 border font-semibold  text-black">{vintage.year}</td>
                ...
                <div className="w-3/5 bg-white border-[1px] rounded-lg shadow-lg">
                    ...
                    <table className="min-w-full bg-white">
                        ...
                        <tbody>
                            {cart.map((item, index) => (
                                <tr key={index}>
                                    <td className="p-4 border-y text-neutral-1200">{item.vintage}</td>
                                    <td className="p-4 border-y text-neutral-1200">{item.quantity}</td>
                                    <td className="p-4 border-y text-neutral-1200">${item.rate}</td>
                                    <td className="p-4 border-y text-neutral-1200">{item.quantity * item.rate}</td>
                                    <td className="p-4 border-y text-neutral-1200">
                                        <button
