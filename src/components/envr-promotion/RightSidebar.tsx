...
export default function Sidebar({ SetShowSideBar }: any) {
    ...
    return (
        <div className="bg-greenPrimary text-white   flex flex-col items-end fixed z-10 top-0 right-0 h-screen w-[100vw]  xl:hidden transition-all duration-100 ease-linear" onClick={() => { SetShowSideBar(false); }}>
            {/* <div className=" bg-green-900 py-[50px] px-[92px] xl:block">
            ...
            <nav className=" bg-neutral-50 flex-1   block w-[25%] min-w-[250px] pt-[110px]">
                <ul>
                    <li onClick={() => handleScroll("hero")} className="px-[30px] py-[35px] cursor-pointer hover:text-gray-300 border-b border-neutral-300 hover:bg-neutral-300">
                        <div className="text-black font-bold text-f-l">Home</div>
                    </li>
                    <li onClick={() => handleScroll("whyUs")} className="px-[30px] py-[35px] cursor-pointer hover:text-gray-300 border-b border-neutral-300 hover:bg-neutral-300">
                        <div className="text-black font-bold text-f-l">Why Us</div>
                    </li>
                    <li onClick={() => handleScroll("consulting")} className="px-[30px] py-[35px] cursor-pointer hover:text-gray-300 border-b border-neutral-300 hover:bg-neutral-300">
                        <div className="text-black font-bold text-f-l">Consulting</div>
                    </li>
                    <li onClick={() => handleScroll("registries")} className="px-[30px] py-[35px] cursor-pointer hover:text-gray-300 border-b border-neutral-300 hover:bg-neutral-300">
                        <div className="text-black font-bold text-f-l">Registries</div>
                    </li>
                    <li onClick={() => handleScroll("contact")} className="px-[30px] py-[35px] cursor-pointer hover:text-gray-300 hover:bg-neutral-300">
                        <div className="text-black font-bold text-f-l">Contact</div>
                    </li>
                </ul>
            </nav>

            {/* <div className=" bg-green-900 w-screen py-[24px] px-[40px] flex justify-between items-center xl:hidden ">
